...
namespace HaywardMachineShopTimeSheet
{
    public partial class Form1 : Form
    {
        ...
        private void btnLog_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Sign in to log informaton.");
            }
            else
            {
                if(cbCode.Text == "")
                {
                    MessageBox.Show("No information has been keyed-in.");
                }
                else
                {
        ...
        private void btnEdit1_Click(object sender, EventArgs e)
        {
            if(lblRow1.Text == "")
            {
                MessageBox.Show("There is no information on row #1 to be edited.");
            }
            else
            {
                tbWorkOrder.Text = lblWorkOrder1.Text;
                tbPart.Text = lblPart1.Text;
                cbMachine.Text = lblMachine1.Text;
                tbOperation.Text = lblOperation1.Text;
                cbCode.Text = lblCode1.Text;
                tbStandardPPH.Text = lblStandardPPH1.Text;
                tbActualPPH.Text = lblActualPPH1.Text;
                tbQuantity.Text = lblQuantity1.Text;
                tbScrap.Text = lblScrap1.Text;
                tbStandardSetupHrs.Text = lblStandardSUHrs1.Text;
                tbActualSetupHrs.Text = lblActualSUHrs1.Text;
        ...
        private void btnEdit2_Click(object sender, EventArgs e)
        {
            if (lblRow2.Text == "")
            {
                MessageBox.Show("There is no information on row #2 to be edited.");
            }
            else
            {
                tbWorkOrder.Text = lblWorkOrder2.Text;
                tbPart.Text = lblPart2.Text;
                cbMachine.Text = lblMachine2.Text;
                tbOperation.Text = lblOperation2.Text;
                cbCode.Text = lblCode2.Text;
                tbStandardPPH.Text = lblStandardPPH2.Text;
                tbActualPPH.Text = lblActualPPH2.Text;
                tbQuantity.Text = lblQuantity2.Text;
                tbScrap.Text = lblScrap2.Text;
                tbStandardSetupHrs.Text = lblStandardSUHrs2.Text;
                tbActualSetupHrs.Text = lblActualSUHrs2.Text;
        ...
        private void btnEdit3_Click(object sender, EventArgs e)
        {
            if (lblRow3.Text == "")
            {
                MessageBox.Show("There is no information on row #3 to be edited.");
            }
            else
            {
                tbWorkOrder.Text = lblWorkOrder3.Text;
                tbPart.Text = lblPart3.Text;
                cbMachine.Text = lblMachine3.Text;
                tbOperation.Text = lblOperation3.Text;
                cbCode.Text = lblCode3.Text;
                tbStandardPPH.Text = lblStandardPPH3.Text;
                tbActualPPH.Text = lblActualPPH3.Text;
                tbQuantity.Text = lblQuantity3.Text;
                tbScrap.Text = lblScrap3.Text;
                tbStandardSetupHrs.Text = lblStandardSUHrs3.Text;
                tbActualSetupHrs.Text = lblActualSUHrs3.Text;
        ...
        private void btnEdit4_Click(object sender, EventArgs e)
        {
            if (lblRow4.Text == "")
            {
                MessageBox.Show("There is no information on row #4 to be edited.");
            }
            else
            {
                tbWorkOrder.Text = lblWorkOrder4.Text;
                tbPart.Text = lblPart4.Text;
                cbMachine.Text = lblMachine4.Text;
                tbOperation.Text = lblOperation4.Text;
                cbCode.Text = lblCode4.Text;
                tbStandardPPH.Text = lblStandardPPH4.Text;
                tbActualPPH.Text = lblActualPPH4.Text;
                tbQuantity.Text = lblQuantity4.Text;
                tbScrap.Text = lblScrap4.Text;
                tbStandardSetupHrs.Text = lblStandardSUHrs4.Text;
                tbActualSetupHrs.Text = lblActualSUHrs4.Text;
        ...
        private void btnEdit5_Click(object sender, EventArgs e)
        {
            if (lblRow5.Text == "")
            {
                MessageBox.Show("There is no information on row #5 to be edited.");
            }
            else
            {
                tbWorkOrder.Text = lblWorkOrder5.Text;
                tbPart.Text = lblPart5.Text;
                cbMachine.Text = lblMachine5.Text;
                tbOperation.Text = lblOperation5.Text;
                cbCode.Text = lblCode5.Text;
                tbStandardPPH.Text = lblStandardPPH5.Text;
                tbActualPPH.Text = lblActualPPH5.Text;
                tbQuantity.Text = lblQuantity5.Text;
                tbScrap.Text = lblScrap5.Text;
                tbStandardSetupHrs.Text = lblStandardSUHrs5.Text;
                tbActualSetupHrs.Text = lblActualSUHrs5.Text;
        ...
        private void btnEdit6_Click(object sender, EventArgs e)
        {
            if (lblRow6.Text == "")
            {
                MessageBox.Show("There is no information on row #6 to be edited.");
            }
            else
            {
                tbWorkOrder.Text = lblWorkOrder6.Text;
                tbPart.Text = lblPart6.Text;
                cbMachine.Text = lblMachine6.Text;
                tbOperation.Text = lblOperation6.Text;
                cbCode.Text = lblCode6.Text;
                tbStandardPPH.Text = lblStandardPPH6.Text;
                tbActualPPH.Text = lblActualPPH6.Text;
                tbQuantity.Text = lblQuantity6.Text;
                tbScrap.Text = lblScrap6.Text;
                tbStandardSetupHrs.Text = lblStandardSUHrs6.Text;
                tbActualSetupHrs.Text = lblActualSUHrs6.Text;
        ...
        private void btnEdit7_Click(object sender, EventArgs e)
        {
            if (lblRow7.Text == "")
            {
                MessageBox.Show("There is no information on row #7 to be edited.");
            }
            else
            {
                tbWorkOrder.Text = lblWorkOrder7.Text;
                tbPart.Text = lblPart7.Text;
                cbMachine.Text = lblMachine7.Text;
                tbOperation.Text = lblOperation7.Text;
                cbCode.Text = lblCode7.Text;
                tbStandardPPH.Text = lblStandardPPH7.Text;
                tbActualPPH.Text = lblActualPPH7.Text;
                tbQuantity.Text = lblQuantity7.Text;
                tbScrap.Text = lblScrap7.Text;
                tbStandardSetupHrs.Text = lblStandardSUHrs7.Text;
                tbActualSetupHrs.Text = lblActualSUHrs7.Text;
        ...
        private void btnEdit8_Click(object sender, EventArgs e)
        {
            if (lblRow8.Text == "")
            {
                MessageBox.Show("There is no information on row #8 to be edited.");
            }
            else
            {
                tbWorkOrder.Text = lblWorkOrder8.Text;
                tbPart.Text = lblPart8.Text;
                cbMachine.Text = lblMachine8.Text;
                tbOperation.Text = lblOperation8.Text;
                cbCode.Text = lblCode8.Text;
                tbStandardPPH.Text = lblStandardPPH8.Text;
                tbActualPPH.Text = lblActualPPH8.Text;
                tbQuantity.Text = lblQuantity8.Text;
                tbScrap.Text = lblScrap8.Text;
                tbStandardSetupHrs.Text = lblStandardSUHrs8.Text;
                tbActualSetupHrs.Text = lblActualSUHrs8.Text;

                lblRow8.Text = "";
            }
        }

        private void btnEdit9_Click(object sender, EventArgs e)
        {
            if (lblRow9.Text == "")
            {
                MessageBox.Show("There is no information on row #9 to be edited.");
            }
            else
            {
                tbWorkOrder.Text = lblWorkOrder9.Text;
                tbPart.Text = lblPart9.Text;
                cbMachine.Text = lblMachine9.Text;
                tbOperation.Text = lblOperation9.Text;
                cbCode.Text = lblCode9.Text;
                tbStandardPPH.Text = lblStandardPPH9.Text;
                tbActualPPH.Text = lblActualPPH9.Text;
                tbQuantity.Text = lblQuantity9.Text;
                tbScrap.Text = lblScrap9.Text;
                tbStandardSetupHrs.Text = lblStandardSUHrs9.Text;
                tbActualSetupHrs.Text = lblActualSUHrs9.Text;

                lblRow9.Text = "";
            }
        }

        private void btnEdit10_Click(object sender, EventArgs e)
        {
            if (lblRow10.Text == "")
            {
                MessageBox.Show("There is no information on row #10 to be edited.");
            }
            else
            {
                tbWorkOrder.Text = lblWorkOrder10.Text;
                tbPart.Text = lblPart10.Text;
                cbMachine.Text = lblMachine10.Text;
                tbOperation.Text = lblOperation10.Text;
                cbCode.Text = lblCode10.Text;
                tbStandardPPH.Text = lblStandardPPH10.Text;
                tbActualPPH.Text = lblActualPPH10.Text;
                tbQuantity.Text = lblQuantity10.Text;
                tbScrap.Text = lblScrap10.Text;
                tbStandardSetupHrs.Text = lblStandardSUHrs10.Text;
                tbActualSetupHrs.Text = lblActualSUHrs10.Text;

                lblRow10.Text = "";
            }
        }

        private void btnEdit11_Click(object sender, EventArgs e)
        {
            if (lblRow11.Text == "")
            {
                MessageBox.Show("There is no information on row #11 to be edited.");
            }
            else
            {
                tbWorkOrder.Text = lblWorkOrder11.Text;
                tbPart.Text = lblPart11.Text;
                cbMachine.Text = lblMachine11.Text;
                tbOperation.Text = lblOperation11.Text;
                cbCode.Text = lblCode11.Text;
                tbStandardPPH.Text = lblStandardPPH11.Text;
                tbActualPPH.Text = lblActualPPH11.Text;
                tbQuantity.Text = lblQuantity11.Text;
                tbScrap.Text = lblScrap11.Text;
                tbStandardSetupHrs.Text = lblStandardSUHrs11.Text;
                tbActualSetupHrs.Text = lblActualSUHrs11.Text;

                lblRow11.Text = "";
            }
        }

        private void btnEdit12_Click(object sender, EventArgs e)
        {
            if (lblRow12.Text == "")
            {
                MessageBox.Show("There is no information on row #12 to be edited.");
            }
            else
            {
                tbWorkOrder.Text = lblWorkOrder12.Text;
                tbPart.Text = lblPart12.Text;
                cbMachine.Text = lblMachine12.Text;
                tbOperation.Text = lblOperation12.Text;
                cbCode.Text = lblCode12.Text;
                tbStandardPPH.Text = lblStandardPPH12.Text;
                tbActualPPH.Text = lblActualPPH12.Text;
                tbQuantity.Text = lblQuantity12.Text;
                tbScrap.Text = lblScrap12.Text;
                tbStandardSetupHrs.Text = lblStandardSUHrs12.Text;
                tbActualSetupHrs.Text = lblActualSUHrs12.Text;
        ...
        private void btnEditCancel_Click(object sender, EventArgs e)
        {
            if(tbWorkOrder.Text == "")
            {
                MessageBox.Show("No previously logged information has been selected for editing.");
            }
            else
            {
                if (lblRow1.Text == "")
